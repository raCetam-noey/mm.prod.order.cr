		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ProductionOrder Manage",
									"targetURL": "#mmprodordercr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mmprodordercr-display": {
								"semanticObject": "mmprodordercr",
								"action": "display",
								"description": "ProductionOrder Manage",
								"title": "ProductionOrder Manage",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mm.prod.order.cr",
									"url": sap.ui.require.toUrl("mm/prod/order/cr")
								}
							}
						}
					}
